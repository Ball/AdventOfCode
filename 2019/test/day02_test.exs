defmodule Day02Test do
    ...
    test "add opcode" do
        assert Day02.execute([1,9,10,3,99,3,11,0,99,30,40,50]) |> elem(0) == [1,9,10,70,99,3,11,0,99,30,40,50]
    end
    test "add and multiply" do
        assert Day02.execute([1,9,10,3,2,3,11,0,99,30,40,50]) |> elem(0) == [3500,9,10,70,2,3,11,0,99,30,40,50]
    end
